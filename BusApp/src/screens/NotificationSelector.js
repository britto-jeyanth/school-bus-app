...
class NotificationSelector extends React.Component {
        ...
        return this.state.listData.map((buttonInfo) => {
            return (
                <SettingsList.Item
                    ...
                    onPress={() => this.props.navigation.navigate('NotificationDetails', {'user': buttonInfo})}
                />
            );
        });
    }
    ...
    render() {
        return (
            <View style={styles.container}>
                ...
                <View style={{backgroundColor: '#F5FCFF', flex: .807, flexDirection: 'column', justifyContent: 'center'}}>
...
export default withNavigation(NotificationSelector)